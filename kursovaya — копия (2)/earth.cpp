...
void Earth::init_earth()
{
    ...
    Point point11;
    point11.x = 39; point11.y = 116; point11.z = 0;
    Point coords11 = geo_to_rect(point11);

    Point point12;
    point12.x = 202; point12.y = 223; point12.z = 0;
    Point coords12 = geo_to_rect(point12);

    points[points_amount] = coords11;
    points_amount++;
    points[points_amount] = coords12;
    points_amount++;
}
